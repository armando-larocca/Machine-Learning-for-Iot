...
if args.version == "little":
    WQ_train = True
    filters = [ 200,90,64]
    d_out = 0.4
    saved_model_dir = "model_little"
    tflite_model_dir = "little.tflite"
    tflite_compressed_dir = "little.tflite.zlib"
    ep = 25
    sp1 = [32,26,10,1]
    sp2 = [1,26,10,1]
    post_q = True
...
elif args.version == "big":
    WQ_train = False
    filters = [ 256, 256, 512, 1024, 1024]
    d_out = 0.4
    saved_model_dir = "model_big"
    tflite_model_dir = "big.tflite"
    tflite_compressed_dir = "big.tflite.zlib"
    ep = 10
    sp1 = [32,49,10,1]
    sp2 = [1,49,10,1]
    post_q = False
